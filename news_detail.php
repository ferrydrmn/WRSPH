...
<body>
    ...
    <main>
        <div class="box-content">
            <h1 style="width: 75%; text-align: left; font-size: 42px;">Judul Berita</h1>
            <h3 style="width: 75%; text-align: left; font-size: 28px;">13/05/2021</h3>
            <img src="img/logo/logo-jumbotron.png" alt="Logo SMA Puncak Harapan" style="margin: 15px 0px; width: 680px;">
            <p>
